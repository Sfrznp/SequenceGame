        ...
        if event.type == pygame.QUIT:
            ...
            if (clicked_row < NUM_ROWS and clicked_col < NUM_COLS) and board[clicked_row][clicked_col] == UNASSIGNED:
                ...
                if current_player == 0:
                    ...
                    print("player 1 card played: ", clicked_cell_value)
                    if clicked_cell_value in player1_hand:
                ...
                elif current_player == 1: #  Will never get to this because of AI agent!
                    """
                    Need to add the AI agent to this section.
                    The find_best_move function should be updated and
                    only choose the best move based on AI (Player 2) hand.
                    """

                    if clicked_cell_value in player2_hand:
                        board[clicked_row][clicked_col] = current_player
                ...
                # print("AI played: ", board[ai_row][ai_col])
